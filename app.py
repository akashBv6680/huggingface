...
# The VGG16 and InceptionV3 model names have been corrected for direct use with the
# transformers library's AutoImageProcessor and AutoModelForImageClassification.
MODEL_MAP = {
    "ResNet-50": "microsoft/resnet-50",
    "EfficientNetB0": "google/efficientnet-b0",
    "VGG16": "microsoft/vgg16",
    "InceptionV3": "google/inception-v3",
